...
const experienceData = [
  {
    ...
    years: '2014 – 2024',
    picture: 'quality-mechanical-expertise.png',
    details: [
...
function generateExperienceHTML(item) {
  return `
      <li class="experience-item fade-in-on-scroll" onclick="toggleExperienceDetails(\'${
        item.id
      }\'); trackExperienceClick(\'${item.analyticsTag}\')">
      <i class="${
        item.icon
      } fa-fw" style="margin-right: 8px; color: #4364F7;"></i>
...
function trackExperienceClick(experienceName) {
  if (typeof gtag === 'function') {
    ...
    console.warn(
      'gtag function not found for tracking experience click:',
      experienceName
    );
  }
}
